              ...
              <div className="mt-10 grid md:grid-cols-3 gap-6 text-left">
                {[
                  ...
                  <button
                    ...
                    className={`group relative flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-2 rounded-2xl border p-4 md:p-6 text-left transition-all hover:scale-[1.02] ${template === item.title
                      ? "border-cyan-400 bg-slate-900 shadow-md shadow-cyan-900/20"
                  ...
                  >
                    ...
                    <div>
                      <h2 className="text-base sm:text-lg md:text-xl font-semibold mb-0.5 md:mb-1 group-hover:text-cyan-200">{item.title}</h2>
        ...
        {step === 10 && (
          <div className="max-w-6xl mx-auto">
            ...
            <div className="overflow-x-auto pb-4 w-full">
              <div ref={resumeRef} style={{ backgroundColor: "#ffffff", color: "#111827", padding: 32, borderRadius: 16, width: "100%", minWidth: 800, maxWidth: 900, margin: "0 auto", boxShadow: "0 20px 60px rgba(0,0,0,0.18)", fontFamily: "Arial, Helvetica, sans-serif" }}>
